...
public class AdaptiveScanWithSVM {
	public static void main(String[] args) throws Exception {
		...
		for(String relationship : relationships){
			...
			SerializationHelper.write("resultsRank/full" + suffix + "/" + sampling + "/"+ updateMethod + "/" + relationship + "/" + extractor + "/" + split + "/initialRankSVM.data", new SortedCurve(numDocs, initialRanking, relevance));
			SerializationHelper.write("resultsRank/full" + suffix + "/" + sampling + "/"+ updateMethod + "/" + relationship + "/" + extractor + "/" + split+ "/adaptiveRankSVM.data", new SortedCurve(numDocs, adaptiveRanking, relevance));
			SerializationHelper.write("resultsRank/full" + suffix + "/" + sampling + "/"+ updateMethod + "/" + relationship + "/" + extractor + "/" + split + "/adaptiveRankSVMUpdates.updates", updates);
			SerializationHelper.write("resultsRank/full" + suffix + "/" + sampling + "/"+ updateMethod + "/" + relationship + "/" + extractor + "/" + split + "/adaptiveRankSVMUpdates.updates.statistics", updateStatistics);
			SerializationHelper.write("resultsRank/full" + suffix + "/" + sampling + "/"+ updateMethod + "/" + relationship + "/" + extractor + "/" + split + "/adaptiveRankSVMTimes.times", measurer.getCheckPoints());
			SerializationHelper.write("resultsRank/full" + suffix + "/" + sampling + "/"+ updateMethod + "/" + relationship + "/" + extractor + "/" + split + "/adaptiveRankSVMtuples.tuples", allTuples);
			if(updateDecision!=null){
