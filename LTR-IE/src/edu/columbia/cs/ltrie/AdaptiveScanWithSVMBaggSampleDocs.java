...
public class AdaptiveScanWithSVMBaggSampleDocs {
...
//						continue;
			...
			SerializationHelper.write("resultsRank/full" + suffix + "/" + sampling + "/"+ updateMethod + "/" + relationship + "/" + extractor + "/" + split + "/initialBagg_SamD.data", new SortedCurve(numDocs, initialRanking, relevance));
			SerializationHelper.write("resultsRank/full" + suffix + "/" + sampling + "/"+ updateMethod + "/" + relationship + "/" + extractor + "/" + split+ "/adaptiveBagg_SamD.data", new SortedCurve(numDocs, adaptiveRanking, relevance));
			SerializationHelper.write("resultsRank/full" + suffix + "/" + sampling + "/"+ updateMethod + "/" + relationship + "/" + extractor + "/" + split + "/adaptiveBaggUpdates_SamD.updates", updates);
			SerializationHelper.write("resultsRank/full" + suffix + "/" + sampling + "/"+ updateMethod + "/" + relationship + "/" + extractor + "/" + split + "/adaptiveBaggUpdates.updates_SamD.statistics", updateStatistics);
			SerializationHelper.write("resultsRank/full" + suffix + "/" + sampling + "/"+ updateMethod + "/" + relationship + "/" + extractor + "/" + split + "/adaptiveBaggTimes_SamD.times", measurer.getCheckPoints());
			SerializationHelper.write("resultsRank/full" + suffix + "/" + sampling + "/"+ updateMethod + "/" + relationship + "/" + extractor + "/" + split + "/adaptiveBaggtuples_SamD.tuples", allTuples);
			if(updateDecision!=null){
